...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator'), array('invalid_message' => 'Please enter a valid code value', 'length' => 5, 'width' => 130, 'height' => 50, 'font' => ($this->targetDirs[3].'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/DependencyInjection/../Generator/Font/captcha.ttf'), 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'as_url' => false, 'reload' => false, 'image_folder' => 'captcha', 'web_path' => ($this->targetDirs[2].'/../web'), 'gc_freq' => 100, 'expiration' => 60, 'quality' => 30, 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'distortion' => true, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true, 'text_color' => array(), 'background_color' => array(), 'disabled' => false));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'demo', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CoreBundle/Entity'))), 'CoreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CoreBundle' => 'CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c4e560eaad71973767b9bf635cd69eb8584a8e78ccf016291f19139a0e073393');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('mohammad@sageagestrategies.com');
        $a->setPassword('30647896@sage');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'GregwarCaptchaBundle::captcha.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'bootstrap_3_horizontal_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('acb1344cdbf59e832cb2e9f84d9fb0a5aedcd236');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('550f1bd6a5d01')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'mohammad@sageagestrategies.com',
            'mailer_password' => '30647896@sage',
            'locale' => 'en',
            'secret' => 'acb1344cdbf59e832cb2e9f84d9fb0a5aedcd236',
            ...
            'kernel.secret' => 'acb1344cdbf59e832cb2e9f84d9fb0a5aedcd236',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mohammad@sageagestrategies.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '30647896@sage',
            ...
            'gregwar_captcha.config' => array(
                'invalid_message' => 'Please enter a valid code value',
                'length' => 5,
                'width' => 130,
                'height' => 50,
